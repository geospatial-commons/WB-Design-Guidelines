...
WB color system for digital dashboards and data products. Sourced from the WBG Digital Look & Feel Style Guide and adapted for front-end development.
...
- {doc}`palettes` — chart and map palettes (not the vertical brand colors)
